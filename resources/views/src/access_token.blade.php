        ...
        <div class="card-body ">
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" required="true"
                       name="emailadress" autocomplete="off">
            </div>
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="password" required="true"
                       name="password" readonly autofocus
                       onfocus="this.removeAttribute('readonly');" autocomplete="off">
            </div>
            <button type="button" class="btn btn-info" id="gettoken">Get Token</button>
        </div>
        <iframe seamless class="col-md-12" id="iframe" src="" frameborder="0"
                style="display:none; wordWrap: break-word" scrolling="auto">
